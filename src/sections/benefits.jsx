        ...
        <div className="container">
          <div className="main-benefits">
            <div className="benefit-item">
              <p className="benefit-item__title heading">25% кешбэк</p>
              <p className="u-collapse-all">
                супермаркеты, одежда, такси, АЗС, аптеки
              </p>
            </div>
            <div className="benefit-item">
              <p className="benefit-item__title heading">Кешбэк 1000 баллов</p>
              <p className="u-collapse-all">
                за покупки на общую сумму от 1 000 ₽
              </p>
            </div>
            <div className="benefit-item">
              <p className="benefit-item__title heading">17%</p>
              <p className="u-collapse-all">
                по накопительному счёту для новых клиентов
              </p>
            </div>
            <div className="benefit-item">
              <p className="benefit-item__title heading">0 ₽</p>
              <p className="u-collapse-all">
                выпуск карты, доставка и обслуживание
              </p>
            </div>
            <div className="benefit-item">
              <p className="benefit-item__title heading">
            ...
            <div className="benefit-item">
              <p className="benefit-item__title heading">Бесплатные переводы</p>
              <p className="u-collapse-all">
